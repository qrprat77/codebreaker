Feature: code-breaker submits guess
	...
	For each number in the guess that matches the number and posiition of a number
	...
	for each of the exact matchees in the first, third and fourth positions.  The 
